...
```
npm create cloudflare@latest -- --template=cloudflare/templates/morning-frog-853b
```

A live public deployment of this template is available at [https://morning-frog-853b.templates.workers.dev](https://morning-frog-853b.templates.workers.dev)
